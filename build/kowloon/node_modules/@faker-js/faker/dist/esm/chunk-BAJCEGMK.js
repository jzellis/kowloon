...
var s = ["{{person.last_name}} {{company.suffix}}", "{{person.male_last_name}} a {{person.male_last_name}} {{company.suffix}}"];
var t = ["s.r.o.", "a.s.", "v.o.s."];
var E = {
    name_pattern: s,
    suffix: t
  },
  l = E;
var u = ["sk", "com", "net", "eu", "org"];
var m = ["gmail.com", "zoznam.sk", "azet.sk"];
var q = {
    domain_suffix: u,
    free_email: m
  },
...
var Q = {
    female_first_name: o,
    female_last_name: L,
    female_last_name_pattern: R,
    female_prefix: e,
    first_name: T,
    male_first_name: r,
    male_last_name: J,
    male_last_name_pattern: A,
    male_prefix: i,
    name: I,
    prefix: G,
    suffix: x,
...
var Y = {
  ...
  C = Y;
exports.a = C;
var Io = new _chunk2JBE4HP.h({
  locale: [C, _chunkTN4M2PHH.b, _chunk2JBE4HP.i]
});
exports.b = Io;