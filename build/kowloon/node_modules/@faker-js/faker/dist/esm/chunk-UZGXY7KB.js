...
var n = ["amarelo", "\xE2mbar", "ametista", "azul", "azul celeste", "azul marinho", "azul petr\xF3leo", "a\xE7afr\xE3o", "bord\xF4", "bronze", "caramelo", "castanho ", "cenoura", "cinza", "cobre", "coral", "dourado", "escarlate", "esmeralda", "ferrugem", "fuligem", "f\xFAchsia", "gren\xE1", "\xEDndigo", "jade", "laranja", "lil\xE1s", "lim\xE3o", "madeira", "magenta", "marrom", "ouro", "pele", "prata", "preto", "p\xFArpura", "rosa", "roxo", "salm\xE3o", "turquesa", "verde", "verde lima", "verde-azulado", "vermelho", "violeta"];
var Z = {
    human: n
  },
  l = Z;
var s = ["Livros", "Filmes", "M\xFAsica", "Jogos", "Eletr\xF4nicos", "Computadores", "Casa", "Jardim", "Ferramentas", "Mercearia", "Sa\xFAde", "Beleza", "Brinquedos", "Crian\xE7as", "Beb\xEA", "Roupas", "Sapatos", "J\xF3ias", "Esportes", "Turismo", "Automotivo", "Industrial"];
var u = {
  adjective: ["Pequeno", "Ergon\xF4mico", "R\xFAstico", "Inteligente", "Lindo", "Incr\xEDvel", "Fant\xE1stico", "Pr\xE1tico", "Lustroso", "Impressionante", "Gen\xE9rico", "Feito \xE0 m\xE3o", "Licenciado", "Refinado", "Sem marca", "Gostoso"],
  material: ["A\xE7o", "Madeira", "Concreto", "Pl\xE1stico", "Algod\xE3o", "Granito", "Borracha", "Metal", "Macio", "Fresco", "Congelado"],
  product: ["Cadeira", "Carro", "Computador", "Teclado", "Mouse", "Bicicleta", "Bola", "Luvas", "Cal\xE7as", "Camiseta", "Mesa", "Sapatos", "Chap\xE9u", "Toalhas", "Sabonete", "Atum", "Frango", "Peixe", "Queijo", "Bacon", "Pizza", "Salada", "Salsicha", "Salgadinhos"]
};
var X = {
    department: s,
    product_name: u
  ...
  m = X;
var d = ["{{person.last_name}} {{company.suffix}}", "{{person.last_name}}-{{person.last_name}}", "{{person.last_name}}, {{person.last_name}} e {{person.last_name}}"];
var p = ["S.A.", "LTDA", "EIRELI", "e Associados", "Com\xE9rcio"];
var $ = {
    name_pattern: d,
    suffix: p
  },
...
var b = {
  wide: ["Domingo", "Segunda", "Ter\xE7a", "Quarta", "Quinta", "Sexta", "S\xE1bado"],
  abbr: ["Dom", "Seg", "Ter", "Qua", "Qui", "Sex", "S\xE1b"]
};
var aa = {
    month: f,
    weekday: b
  ...
  M = aa;
var g = ["br", "com", "biz", "info", "name", "net", "org"];
var S = ["gmail.com", "yahoo.com", "hotmail.com", "live.com", "bol.com.br"];
var ea = {
    domain_suffix: g,
    free_email: S
  },
  C = ea;
var h = ["#####", "####", "###"];
var v = ["{{person.firstName}}{{location.city_suffix}}", "{{person.lastName}}{{location.city_suffix}}"];
var x = null;
var A = [" do Descoberto", " de Nossa Senhora", " do Norte", " do Sul"];
...
var P = ["Brasil"];
var B = ["#####-###"];
var D = ["Apto. ###", "Sobrado ##", "Casa #", "Lote ##", "Quadra ##"];
var q = ["Acre", "Alagoas", "Amap\xE1", "Amazonas", "Bahia", "Cear\xE1", "Distrito Federal", "Esp\xEDrito Santo", "Goi\xE1s", "Maranh\xE3o", "Mato Grosso", "Mato Grosso do Sul", "Minas Gerais", "Par\xE1", "Para\xEDba", "Paran\xE1", "Pernambuco", "Piau\xED", "Rio de Janeiro", "Rio Grande do Norte", "Rio Grande do Sul", "Rond\xF4nia", "Roraima", "Santa Catarina", "S\xE3o Paulo", "Sergipe", "Tocantins"];
var I = ["AC", "AL", "AP", "AM", "BA", "CE", "DF", "ES", "GO", "MA", "MT", "MS", "MG", "PA", "PB", "PR", "PE", "PI", "RJ", "RN", "RS", "RO", "RR", "SC", "SP", "SE", "TO"];
var E = ["{{person.firstName}} {{location.street_suffix}}", "{{person.lastName}} {{location.street_suffix}}"];
var R = ["Rua", "Avenida", "Travessa", "Alameda", "Marginal", "Rodovia"];
var oa = {
    building_number: h,
    city_pattern: v,
    city_prefix: x,
...
var w = (0, _chunkTN4M2PHH.a)(a, e);
var j = ["Feminino", "Masculino"];
var O = ["Jr.", "Neto", "Filho"];
var Q = {
  descriptor: ["L\xEDder", "Senior", "Direto", "Corporativo", "Din\xE2mico", "Futuro", "Produto", "Nacional", "Regional", "Distrito", "Central", "Global", "Cliente", "Investidor", "International", "Legado", "Avan\xE7ar", "Interno", "Humano", "Chefe", "Principal"],
  level: ["Solu\xE7\xF5es", "Programa", "Marca", "Seguran\xE7a", "Pesquisar", "Marketing", "Diretivas", "Implementation", "Implementa\xE7\xE3o", "Funcionalidade", "Resposta", "Paradigma", "T\xE1ticas", "Identidade", "Mercados", "Grupo", "Divis\xE3o", "Aplica\xE7\xF5es", "Otimiza\xE7\xE3o", "Opera\xE7\xF5es", "Infraestrutura", "Intranet", "Comunica\xE7\xF5es", "Web", "Branding", "Qualidade", "Assurance", "Mobilidade", "Contas", "Dados", "Criativo", "Configuration", "Presta\xE7\xE3o de contas", "Intera\xE7\xF5es", "Fatores", "Usabilidade", "M\xE9tricas"],
  job: ["Supervisor", "Associado", "Executivo", "Atentende", "Policial", "Gerente", "Engenheiro", "Especialista", "Diretor", "Coordenador", "Administrador", "Arquiteto", "Analista", "Designer", "Planejador", "Orquestrador", "T\xE9cnico", "Desenvolvedor", "Produtor", "Consultor", "Assistente", "Facilitador", "Agente", "Representante", "Estrategista"]
};
var U = ["Aqu\xE1rio", "Peixes", "\xC1ries", "Touro", "G\xEAmeos", "C\xE2ncer", "Le\xE3o", "Virgem", "Libra", "Escorpi\xE3o", "Sagit\xE1rio", "Capric\xF3rnio"];
var ta = {
    female_first_name: _,
    female_prefix: a,
    first_name: J,
...
var la = {
  ...
  W = la;
exports.a = W;
var ao = new _chunk2JBE4HP.h({
  locale: [W, _chunkTN4M2PHH.b, _chunk2JBE4HP.i]
});
exports.b = ao;