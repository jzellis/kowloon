...
```jsonc
{
  ...
  "replyTo": "@public|@example.org|circle:…|group:…|event:…",// (optional) **single string**
  "reactTo": "@public|@example.org|circle:…|group:…|event:…",// (optional) **single string**
...
## Changelog
- **2025‑10‑22**: Added proposed subtype catalogs for Event, Group, Circle (descriptive only).
