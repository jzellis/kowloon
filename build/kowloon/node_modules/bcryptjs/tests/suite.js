...
module.exports = {
  "encodeBase64": function encodeBase64(test) {
  ...
  "decodeBase64": function decodeBase64(test) {
  ...
  "genSaltSync": function genSaltSync(test) {
  ...
  "hashSync": function hashSync(test) {
  ...
  "compareSync": function compareSync(test) {
  ...
  "getRounds": function getRounds(test) {
    var hash1 = bcrypt.hashSync("hello", bcrypt.genSaltSync());
    test.equal(bcrypt.getRounds(hash1), 10);
    test.done();
  },
  "progress": function progress(test) {
  ...
  "compat": {
    "quickbrown": function quickbrown(test) {
    ...
    "roundsOOB": function roundsOOB(test) {
