...
var i = ["Venture", "Ltd", "Plc"];
var c = {
    suffix: i
  },
  n = c;
var u = ["com.ng", "com", "org.ng", "ng"];
var B = {
    domain_suffix: u
  },
  r = B;
...
var l = ["{{location.city_name}}"];
var m = ["Nigeria", "Federal Republic of Nigeria", "NG", "NGN"];
var I = ["#####", "####"];
var b = ["FCT", "ABIA", "ADAMAWA", "Akwa Ibom", "Anambra", "Bauchi", "Bayelsa", "Benue", "Bornu", "Cross River", "Delta", "Ebonyi", "Edo", "Ekiti", "Enugu", "Gombe", "Imo", "Jigawa", "Kaduna", "Kano", "Katsina", "Kebbi", "Kogi", "Kwara", "Lagos", "Nasarawa", "Niger", "Ogun", "Ondo", "Osun", "Oyo", "Plateau", "Rivers", "Sokoto", "Taraba", "Yobe", "Zamfara"];
var A = ["{{person.firstName}} {{location.street_suffix}}", "{{person.lastName}} {{location.street_suffix}}"];
var G = {
    city_name: t,
    city_pattern: l,
    default_country: m,
...
var f = ["Abimbola", "Abisola", "Abisoye", "Adeboye", "Adedayo", "Adegoke", "Akande", "Akanni", "Alade", "Ayinde", "Azubuike", "Banji", "Bankole", "Buchi", "Bukola", "Chinedu", "Chisom", "Chukwu", "Damilare", "Damilola", "Danjuma", "Ebiowei", "Emeka", "Emmanuel", "Esse", "Funmilade", "Funmilayo", "Gbeminiyi", "Gbemisola", "Habiba", "Ifeanyichukwu", "Ikenna", "Ikhidie", "Ireti", "Jadesola", "Johnson", "Kayode", "Kemi", "Kubra", "Kubura", "Lolade", "Makinwa", "Mohammed", "Musa", "Muyiwa", "Nnamdi", "Olaide", "Olufunmi", "Olumide", "Oluwunmi", "Onoriode", "Remilekun", "Rotimi", "Shade", "Shalewa", "Sname", "Tari", "Temitope", "Titilope", "Tobiloba", "Toke", "Tomiloba", "Tope", "Uzodimma", "Wale", "Yakubu", "Yusuf"];
var y = [{
...
var T = {
  ...
  h = T;
var j = ["0803 ### ####", "0703 ### ####", "234809 ### ####", "+234 802 ### ####", "0805### ####"];
var N = {
    formats: j
  },
  E = N;
var D = {
  ...
  O = D;
exports.a = O;
var ca = new _chunk2JBE4HP.h({
  locale: [O, _chunkTN4M2PHH.b, _chunk2JBE4HP.i]
});
exports.b = ca;