 ...
 */
(function (a, b) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? b(exports) : "function" == typeof define && define.amd ? define(["exports"], b) : (a = a || self, b(a.AbortControllerShim = {}));
})(void 0, function (a) {
  'use strict';
  ...
  function j(a, b) {
    return b && ("object" == _typeof(b) || "function" == typeof b) ? b : i(a);
  }
  function k(a) {
    var b = F.get(a);
  ...
  function m(a, b) {
    ...
    for (var c, d = Object.keys(b), e = 0; e < d.length; ++e) c = d[e], c in this || Object.defineProperty(this, c, n(c));
  }
  function n(a) {
    return {
      get: function get() {
  ...
  function p(a, b) {
    ...
    for (var e, f = 0; f < d.length; ++f) if (e = d[f], !(e in a.prototype)) {
  ...
  function D(a) {
    !1 !== L.get(a) || (L.set(a, !0), a.dispatchEvent({
      type: "abort"
    }));
  }
  function E(a) {
  ...
  B.prototype = {
    ...
    removeEventListener: function removeEventListener(a, b, c) {
      if (null != b) for (var d = x(this), e = w(c) ? !!c.capture : !!c, f = e ? I : J, g = null, h = d.get(a); null != h;) {
    ...
    dispatchEvent: function dispatchEvent(a) {
      ...
      for (var e = r(this, a), f = null; null != d;) {
        if (d.once ? null === f ? null === d.next ? b["delete"](c) : b.set(c, d.next) : f.next = d.next : f = d, v(e, d.passive ? d.listener : null), "function" == typeof d.listener) try {
  ...
  var K = function (a) {
    ...
    return f(d, a), e(d, [{
      ...
      get: function get() {
        var a = L.get(this);
        if ("boolean" != typeof a) throw new TypeError("Expected 'this' to be an 'AbortSignal' object, but got ".concat(null === this ? "null" : b(this)));
        return a;
      }
    }]), d;
  }(B);
  ...
  }), "function" == typeof Symbol && "symbol" === b(Symbol.toStringTag) && Object.defineProperty(K.prototype, Symbol.toStringTag, {
    configurable: !0,
    value: "AbortSignal"
  });
  var M = function () {
    ...
    N = new WeakMap();
  if (Object.defineProperties(M.prototype, {
    signal: {
      enumerable: !0
    },
    abort: {
  ...
  }), "function" == typeof Symbol && "symbol" === b(Symbol.toStringTag) && Object.defineProperty(M.prototype, Symbol.toStringTag, {
    configurable: !0,
    value: "AbortController"
  }), a.AbortController = M, a.AbortSignal = K, a["default"] = M, Object.defineProperty(a, "__esModule", {
    value: !0
