...
exports.settingsSlice = exports.setSettings = exports["default"] = exports.changeSetting = void 0;
...
var settingsSlice = (0, _toolkit.createSlice)({
  ...
  reducers: {
    ...
    changeSetting: function changeSetting(state, action) {
      // Redux Toolkit allows us to write "mutating" logic in reducers. It
      // doesn't actually mutate the state because it uses the Immer library,
      // which detects changes to a "draft state" and produces a brand new
      // immutable state based off those changes
...
var _settingsSlice$action = settingsSlice.actions,
  ...
  changeSetting = _settingsSlice$action.changeSetting;
