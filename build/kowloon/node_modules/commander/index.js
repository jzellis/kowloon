...
var Option = /*#__PURE__*/function () {
  ...
  function Option(flags, description) {
    ...
    var optionFlags = _parseOptionFlags(flags);
...
var Command = /*#__PURE__*/function (_EventEmitter) {
  ...
  var _super2 = _createSuper(Command);
  /**
  ...
  function Command(name) {
    ...
    _this2._storeOptionsAsPropertiesCalled = false;
    ...
    _this2._aliases = [];
    _this2._combineFlagAndOptionalValue = true;
    _this2._hidden = false;
    _this2._hasHelpOption = true;
  ...
  _createClass(Command, [{
    ...
    function _lazyHasImplicitHelpCommand() {
    ...
    function action(fn) {
      ...
      var listener = function listener(args) {
        ...
        var actionResult = fn.apply(_this4, actionArgs);
    ...
    function _checkForOptionNameClash(option) {
      ...
      var commandProperty = this._getOptionValue(option.attributeName());
      ...
      if (option.negate) {
        ...
        var negativeLongFlag = option["long"].replace(/^--/, '--no-');
        foundClash = !this._findOption(negativeLongFlag);
      }
      if (foundClash) {
        throw new Error("option '".concat(option.name(), "' clashes with existing property '").concat(option.attributeName(), "' on Command\n- call storeOptionsAsProperties(false) to store option values safely,\n- or call storeOptionsAsProperties(true) to suppress this check,\n- or change option name\n\nRead more on https://git.io/JJc0W"));
      }
    }
  }, {
    key: "_optionEx",
    ...
    function _optionEx(config, flags, description, fn, defaultValue) {
      var _this5 = this;
      ...
      this.on('option:' + oname, function (val) {
        var oldValue = _this5._getOptionValue(name);
    ...
    function option(flags, description, fn, defaultValue) {
    ...
    */
     ...
     * @api public
     */
    function combineFlagAndOptionalValue(arg) {
     ...
     * @api public
     */
    function allowUnknownOption(arg) {
    ...
    function storeOptionsAsProperties(value) {
    ...
    function passCommandToAction(value) {
    ...
    function unknownCommand() {
      ...
      var message = "error: unknown command '".concat(this.args[0], "'.") + (this._hasHelpOption ? " See '".concat(fullCommand, " ").concat(this._helpLongFlag, "'.") : '');
      console.error(message);
    ...
    function optionHelp() {
      ...
      // Implicit help
      var showShortHelpFlag = this._hasHelpOption && this._helpShortFlag && !this._findOption(this._helpShortFlag);
      var showLongHelpFlag = this._hasHelpOption && !this._findOption(this._helpLongFlag);
    ...
    function helpOption(flags, description) {
      ...
      var helpFlags = _parseOptionFlags(this._helpFlags);
