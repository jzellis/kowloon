...
var o = function o(h, n) {
    for (var T in n) i(h, T, {
      get: n[T],
      enumerable: !0
    });
  },
  N = function N(h, n, T, u) {
    if (n && _typeof(n) == "object" || typeof n == "function") {
      ...
      try {
        var _loop = function _loop() {
          var g = _step.value;
          !c.call(h, g) && g !== T && i(h, g, {
            get: function get() {
              return n[g];
            },
            enumerable: !(u = H(n, g)) || u.enumerable
          });
        };
