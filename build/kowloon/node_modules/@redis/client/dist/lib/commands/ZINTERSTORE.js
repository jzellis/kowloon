...
function transformArguments(destination, keys, options) {
  var args = (0, generic_transformers_1.pushVerdictArgument)(['ZINTERSTORE', destination], keys);
  if (options !== null && options !== void 0 && options.WEIGHTS) {
    args.push.apply(args, ['WEIGHTS'].concat(_toConsumableArray(options.WEIGHTS.map(function (weight) {
      return weight.toString();
    }))));
  }
  if (options !== null && options !== void 0 && options.AGGREGATE) {
