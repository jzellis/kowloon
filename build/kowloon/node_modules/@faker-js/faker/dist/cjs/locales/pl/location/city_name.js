...
var c = function c(i, o) {
    for (var e in o) z(i, e, {
      get: o[e],
      enumerable: !0
    });
  },
  s = function s(i, o, e, w) {
    if (o && _typeof(o) == "object" || typeof o == "function") {
      var _iterator = _createForOfIteratorHelper(n(o)),
        _step;
      try {
        var _loop = function _loop() {
          var a = _step.value;
          !k.call(i, a) && a !== e && z(i, a, {
            get: function get() {
              return o[a];
            },
            enumerable: !(w = r(o, a)) || w.enumerable
          });
        };
