...
function checkForRemovedStyleOptions(mountingOptions) {
  for (var _i2 = 0, _arr = ['cssFile', 'cssFiles', 'style', 'styles', 'stylesheet', 'stylesheets']; _i2 < _arr.length; _i2++) {
    var key = _arr[_i2];
  ...
  BaseWrapper.prototype.trigger = function (eventString, options) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        return [2 /*return*/, (0, Vue.nextTick)()];
      });
    });
  };
  return BaseWrapper;
...
var attachEmitListener = function attachEmitListener() {
  ...
  (0, Vue.setDevtoolsHook)(createDevTools(), {});
};
...
var VueWrapper = /** @class */function (_super) {
  ...
  Object.defineProperty(VueWrapper.prototype, "hasMultipleRoots", {
    get: function get() {
      ...
      //   <WithMultipleRoots />
      // </template>
      var checkTree = function checkTree(subTree) {
        var _a;
...
function processSlot(source, Vue$1) {
  ...
  // transition
  var code = (0, _compilerDom.compile)("<transition>".concat(template, "</transition>"), {
    mode: 'function',
  ...
  return (0, Vue.defineComponent)({
    ...
    setup: function setup(props, _a) {
      ...
      return function () {
        ...
        return (0, Vue.h)(tag, stubProps, renderStubDefaultSlot ? slots : undefined);
      };
    }
  });
};
...
function createStubComponentsTransformer(_a) {
  ...
  return function componentsTransformer(type, instance) {
    ...
    if ((type === Vue.Transition || type === Vue.BaseTransition) && 'transition' in stubs) {
...
function createInstance(inputComponent, options) {
  ...
  if (isFunctionalComponent(originalComponent) || isLegacyFunctionalComponent(originalComponent)) {
    component = (0, Vue.defineComponent)(_assign({
      compatConfig: {
        MODE: 3,
      ...
      setup: function setup(props, _a) {
        var attrs = _a.attrs,
          slots = _a.slots;
        return function () {
          return (0, Vue.h)(originalComponent, _assign(_assign({}, props), attrs), slots);
        };
      }
    }, instanceOptions));
  ...
  var refs = (0, Vue.shallowReactive)({});
  var props = (0, Vue.reactive)({});
  ...
  var componentRef = (0, Vue.ref)(null);
  // create the wrapper component
  var Parent = (0, Vue.defineComponent)({
    name: 'VTU_ROOT',
    ...
    render: function render() {
      return (0, Vue.h)(component, _assign(_assign({}, props), refs), slots);
    }
  });
  // create the app
  var app = (0, Vue.createApp)(Parent);
  ...
  if (global === null || global === void 0 ? void 0 : global.mocks) {
    var mixin = (0, Vue.defineComponent)({
  ...
  (0, Vue.transformVNodeArgs)(createVNodeTransformer({
...
var shallowMount$1 = function shallowMount$1(component, options) {
  return mount$1(component, _assign(_assign({}, options), {
    shallow: true
  }));
};
function renderToString(component, options) {
  var app = createInstance(component, options).app;
  return (0, _serverRenderer.renderToString)(app);
}
...
var RouterLinkStub = (0, Vue.defineComponent)({
  name: 'RouterLinkStub',
  compatConfig: {
    MODE: 3
  },
  ...
  render: function render() {
    var _this = this;
    var _a, _b;
    var route = (0, Vue.computed)(function () {
      return defaultRoute;
    });
    ...
    var children = (_b = (_a = this.$slots) === null || _a === void 0 ? void 0 : _a["default"]) === null || _b === void 0 ? void 0 : _b.call(_a, {
      route: route,
      href: (0, Vue.computed)(function () {
        return route.value.href;
      }),
      isActive: (0, Vue.computed)(function () {
        return false;
      }),
      isExactActive: (0, Vue.computed)(function () {
        return false;
      }),
    ...
    return this.custom ? children : (0, Vue.h)('a', undefined, children);
  }
});
...
var VTUmount = _VueTestUtils.mount,
  shallowMount = _VueTestUtils.shallowMount,
...
var cleanup = function cleanup() {
  ...
  Cypress.$("#".concat(VUE_ROOT)).remove();
 ...
 * })
 */
function mount(componentOptions) {
  ...
  return cy.then(function () {
    ...
    var wrapper = VTUmount(componentOptions, Object.assign({
      attachTo: componentNode
    }, options));
    ...
    return cy.wait(1, {
      ...
      if (options.log !== false) {
        ...
        var message = "<".concat(getComponentDisplayName(componentOptions), " ... />");
        Cypress.log({
          name: 'mount',
          message: [message]
        });
 ...
 */
function mountCallback(component) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  return function () {
