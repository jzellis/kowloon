...
function _handler() {
  _handler = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var _this = this;
    var db, settings, client, allUsers;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          _context2.t2 = "";
          _context2.next = 10;
          return _index.Activity.countDocuments();
        case 10:
          _context2.t3 = _context2.sent;
          _context2.t1 = _context2.t2.concat.call(_context2.t2, _context2.t3, " activities, ");
          _context2.next = 14;
          return _index.User.countDocuments();
        case 14:
          _context2.t4 = _context2.sent;
          _context2.t5 = _context2.t1.concat.call(_context2.t1, _context2.t4, " users");
          _context2.t0.log.call(_context2.t0, _context2.t5);
          _context2.next = 19;
          return _index.Settings.find({});
        case 19:
        ...
        case 25:
          this.redis = client;
          _context2.next = 28;
          return _index.User.find({}, "actor");
        case 28:
          allUsers = _context2.sent;
          _context2.next = 31;
          return Promise.all(allUsers.map( /*#__PURE__*/function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(u) {
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return _this.redis.set(_this.hash(u.actor.id), JSON.stringify(u.actor));
                  case 2:
