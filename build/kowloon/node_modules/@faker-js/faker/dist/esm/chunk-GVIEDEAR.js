...
var H = {
  ...
  C = H;
var A = ["com", "net", "org", "it"];
var z = ["gmail.com", "yahoo.com", "hotmail.com", "email.it", "libero.it", "yahoo.it"];
var K = {
    domain_suffix: A,
    free_email: z
  },
...
var F = ["AG", "AL", "AN", "AO", "AR", "AP", "AT", "AV", "BA", "BT", "BL", "BN", "BG", "BI", "BO", "BZ", "BS", "BR", "CA", "CL", "CB", "CI", "CE", "CT", "CZ", "CH", "CO", "CS", "CR", "KR", "CN", "EN", "FM", "FE", "FI", "FG", "FC", "FR", "GE", "GO", "GR", "IM", "IS", "SP", "AQ", "LT", "LE", "LC", "LI", "LO", "LU", "MC", "MN", "MS", "MT", "ME", "MI", "MO", "MB", "NA", "NO", "NU", "OT", "OR", "PD", "PA", "PR", "PV", "PG", "PU", "PE", "PC", "PI", "PT", "PN", "PZ", "PO", "RG", "RA", "RC", "RE", "RI", "RN", "RM", "RO", "SA", "VS", "SS", "SV", "SI", "SR", "SO", "TA", "TE", "TR", "TO", "OG", "TP", "TN", "TV", "TS", "UD", "VA", "VE", "VB", "VC", "VR", "VV", "VI", "VT"];
var V = {
  normal: "{{location.street}} {{location.buildingNumber}}",
  full: "{{location.street}} {{location.buildingNumber}}, {{location.secondaryAddress}}"
};
var R = ["{{location.street_suffix}} {{person.first_name}}", "{{location.street_suffix}} {{person.last_name}}"];
var E = ["Piazza", "Strada", "Via", "Borgo", "Contrada", "Rotonda", "Incrocio"];
var j = {
    building_number: p,
    city_name: S,
    city_pattern: b,
