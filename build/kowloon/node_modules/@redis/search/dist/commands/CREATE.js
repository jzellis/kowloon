...
function transformArguments(index, schema, options) {
  ...
  if (options !== null && options !== void 0 && options.ON) {
  ...
  if (options !== null && options !== void 0 && options.FILTER) {
    args.push('FILTER', options.FILTER);
  }
  if (options !== null && options !== void 0 && options.LANGUAGE) {
    args.push('LANGUAGE', options.LANGUAGE);
  }
  if (options !== null && options !== void 0 && options.LANGUAGE_FIELD) {
    args.push('LANGUAGE_FIELD', options.LANGUAGE_FIELD);
  }
  if (options !== null && options !== void 0 && options.SCORE) {
    args.push('SCORE', options.SCORE.toString());
  }
  if (options !== null && options !== void 0 && options.SCORE_FIELD) {
    args.push('SCORE_FIELD', options.SCORE_FIELD);
  }
  // if (options?.PAYLOAD_FIELD) {
  //     args.push('PAYLOAD_FIELD', options.PAYLOAD_FIELD);
  // }
  if (options !== null && options !== void 0 && options.MAXTEXTFIELDS) {
    args.push('MAXTEXTFIELDS');
  }
  if (options !== null && options !== void 0 && options.TEMPORARY) {
    args.push('TEMPORARY', options.TEMPORARY.toString());
  }
  if (options !== null && options !== void 0 && options.NOOFFSETS) {
    args.push('NOOFFSETS');
  }
  if (options !== null && options !== void 0 && options.NOHL) {
    args.push('NOHL');
  }
  if (options !== null && options !== void 0 && options.NOFIELDS) {
    args.push('NOFIELDS');
  }
  if (options !== null && options !== void 0 && options.NOFREQS) {
    args.push('NOFREQS');
  }
  if (options !== null && options !== void 0 && options.SKIPINITIALSCAN) {
