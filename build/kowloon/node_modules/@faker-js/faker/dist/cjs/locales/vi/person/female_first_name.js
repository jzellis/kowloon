...
var N = function N(h, n) {
    for (var T in n) g(h, T, {
      get: n[T],
      enumerable: !0
    });
  },
  L = function L(h, n, T, u) {
    if (n && _typeof(n) == "object" || typeof n == "function") {
      var _iterator = _createForOfIteratorHelper(H(n)),
        _step;
      try {
        var _loop = function _loop() {
          var i = _step.value;
          !y.call(h, i) && i !== T && g(h, i, {
            get: function get() {
              return n[i];
            },
            enumerable: !(u = a(n, i)) || u.enumerable
          });
        };
