...
var s = function s(i, a) {
    for (var o in a) z(i, o, {
      get: a[o],
      enumerable: !0
    });
  },
  m = function m(i, a, o, c) {
    if (a && _typeof(a) == "object" || typeof a == "function") {
      var _iterator = _createForOfIteratorHelper(y(a)),
        _step;
      try {
        var _loop = function _loop() {
          var e = _step.value;
          !r.call(i, e) && e !== o && z(i, e, {
            get: function get() {
              return a[e];
            },
            enumerable: !(c = n(a, e)) || c.enumerable
          });
        };
