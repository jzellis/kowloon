...
const ActivitySchema = new Schema(
  {
    ...
    to: { type: [String], default: undefined }, // This is for tagging users (if activity is visible to them or public)
    bto: { type: [String], default: undefined }, // This is for private messages
    cc: { type: [String], default: undefined }, // This is where Group IDs go if a activity is meant to be sent to a group
    bcc: { type: [String], default: undefined }, // This is where Circle IDs go if a activity is only visible to certain circles
