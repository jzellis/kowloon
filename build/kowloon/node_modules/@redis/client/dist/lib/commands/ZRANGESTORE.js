...
function transformArguments(dst, src, min, max, options) {
  var args = ['ZRANGESTORE', dst, src, (0, generic_transformers_1.transformStringNumberInfinityArgument)(min), (0, generic_transformers_1.transformStringNumberInfinityArgument)(max)];
  ...
  if (options !== null && options !== void 0 && options.REV) {
    args.push('REV');
  }
  if (options !== null && options !== void 0 && options.LIMIT) {
    args.push('LIMIT', options.LIMIT.offset.toString(), options.LIMIT.count.toString());
  }
  if (options !== null && options !== void 0 && options.WITHSCORES) {
