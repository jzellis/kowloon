...
function createInstance(inputComponent, options) {
  ...
  if (isFunctionalComponent(originalComponent) || isLegacyFunctionalComponent(originalComponent)) {
    component = Vue.defineComponent(_assign({
      compatConfig: {
        MODE: 3,
      ...
      setup: function setup(props, _a) {
        var attrs = _a.attrs,
          slots = _a.slots;
        return function () {
          return Vue.h(originalComponent, _assign(_assign({}, props), attrs), slots);
        };
      }
    }, instanceOptions));
  ...
  var Parent = Vue.defineComponent({
    ...
    render: function render() {
      return Vue.h(component, _assign(_assign({}, props), refs), slots);
    }
  });
  // create the app
