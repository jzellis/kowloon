...
var getVersionDir = function getVersionDir() {
  var version = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : util.pkgVersion();
  var buildInfo = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : util.pkgBuildInfo();
 ...
 */
var getBinaryPkgAsync = function getBinaryPkgAsync(binaryDir) {
...
var getBinaryPkgVersion = function getBinaryPkgVersion(o) {
  return _.get(o, 'version', null);
};
var getBinaryElectronVersion = function getBinaryElectronVersion(o) {
  return _.get(o, 'electronVersion', null);
};
var getBinaryElectronNodeVersion = function getBinaryElectronNodeVersion(o) {
  return _.get(o, 'electronNodeVersion', null);
};
module.exports = {
  getPathToExecutable: getPathToExecutable,
  getPlatformExecutable: getPlatformExecutable,
  // those names start to sound like Java
  getBinaryElectronNodeVersion: getBinaryElectronNodeVersion,
  getBinaryElectronVersion: getBinaryElectronVersion,
  getBinaryPkgVersion: getBinaryPkgVersion,
  getBinaryVerifiedAsync: getBinaryVerifiedAsync,
  getBinaryPkgAsync: getBinaryPkgAsync,
