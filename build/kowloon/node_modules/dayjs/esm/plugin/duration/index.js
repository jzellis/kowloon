...
var MILLISECONDS_A_YEAR = _constant.MILLISECONDS_A_DAY * 365;
var MILLISECONDS_A_MONTH = _constant.MILLISECONDS_A_DAY * 30;
var durationRegex = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/;
var unitToMS = {
  years: MILLISECONDS_A_YEAR,
  months: MILLISECONDS_A_MONTH,
  days: _constant.MILLISECONDS_A_DAY,
  hours: _constant.MILLISECONDS_A_HOUR,
  minutes: _constant.MILLISECONDS_A_MINUTE,
  seconds: _constant.MILLISECONDS_A_SECOND,
  milliseconds: 1,
  weeks: _constant.MILLISECONDS_A_WEEK
};
...
var Duration = /*#__PURE__*/function () {
  ...
  _proto.parseFromMilliseconds = function parseFromMilliseconds() {
    ...
    this.$d.days = roundNumber($ms / _constant.MILLISECONDS_A_DAY);
    $ms %= _constant.MILLISECONDS_A_DAY;
    this.$d.hours = roundNumber($ms / _constant.MILLISECONDS_A_HOUR);
    $ms %= _constant.MILLISECONDS_A_HOUR;
    this.$d.minutes = roundNumber($ms / _constant.MILLISECONDS_A_MINUTE);
    $ms %= _constant.MILLISECONDS_A_MINUTE;
    this.$d.seconds = roundNumber($ms / _constant.MILLISECONDS_A_SECOND);
    $ms %= _constant.MILLISECONDS_A_SECOND;
...
var _default = function _default(option, Dayjs, dayjs) {
  $d = dayjs;
  $u = dayjs().$utils();
