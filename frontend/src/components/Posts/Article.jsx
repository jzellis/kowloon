...
const Article = (post) => {
    ...
    return (<>
        <li key={post.key} className="post Article card w-full shadow-sm p-4 border border-article-100 bg-white">
            ...
            {post.image && <div className="relative h-64 overflow-hidden w-auto rounded-lg mb-8"><img className="absolute top-1/2 left-0 w-full -translate-y-1/2" src={post.image} /></div>}
