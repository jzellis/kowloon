    ...
    if (e && _typeof(e) == "object" || typeof e == "function") {
      ...
      try {
        var _loop = function _loop() {
          var i = _step.value;
          !c.call(t, i) && i !== r && n(t, i, {
            get: function get() {
              return e[i];
            },
            enumerable: !(a = h(e, i)) || a.enumerable
          });
        };
...
var u = function u(t) {
  return f(n({}, "__esModule", {
    value: !0
  }), t);
};
var p = {};
o(p, {
  VehicleModule: function VehicleModule() {
    return s;
  }
});
module.exports = u(p);
var s = /*#__PURE__*/function () {
  ...
  _createClass(s, [{
    ...
    value: function vehicle() {
      return "".concat(this.manufacturer(), " ").concat(this.model());
    }
  }, {
    key: "manufacturer",
    ...
    value: function vin() {
      var e = ["o", "i", "q", "O", "I", "Q"];
      return "".concat(this.faker.string.alphanumeric({
        length: 10,
        casing: "upper",
        exclude: e
      })).concat(this.faker.string.alpha({
        length: 1,
        casing: "upper",
        exclude: e
      })).concat(this.faker.string.alphanumeric({
        length: 1,
        casing: "upper",
        exclude: e
      })).concat(this.faker.number["int"]({
        min: 1e4,
        max: 99999
      }));
    }
    ...
    key: "vrm",
    value: function vrm() {
      return "".concat(this.faker.string.alpha({
        length: 2,
        casing: "upper"
      })).concat(this.faker.string.numeric({
        length: 2,
        allowLeadingZeros: !0
      })).concat(this.faker.string.alpha({
        length: 3,
