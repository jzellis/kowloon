...
const Article = (post) => {
    ...
    return (<>
        <li key={post.key} className="post Article card w-full shadow-sm p-4 border border-article-100 bg-white">
            ...
            <div className="meta text-xs flex mt-4">
                <div className="flex-1 font-bold">
                    <GrDocumentText className="inline text-gray-500 mr-8" title="Article" />
                    <NavLink className="hover:underline decoration-dotted" to={`/posts/${post.id}#replies`}><span className="mr-8 "><FaReply className="inline" title="Reply" /> {post.replyCount}</span></NavLink>
