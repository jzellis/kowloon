...
exports.makeUnmountFn = exports.makeMountFn = exports.getContainerEl = exports.createMount = void 0;
exports.mount = mount;
...
var _mount = function _mount(jsx) {
...
function mount(jsx) {
  ...
  if (major_1(React["default"].version) === 18) {
  ...
  var internalOptions = {
    ...
    render: function render(reactComponent, el, reactDomToUse) {
      lastReactDom = reactDomToUse || _reactDom["default"];
 ...
 * @see https://on.cypress.io/migration-11-0-0-component-testing-updates
 */
var mountHook = function mountHook(hookFn) {
