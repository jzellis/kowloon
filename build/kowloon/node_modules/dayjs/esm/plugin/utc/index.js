...
var _default = function _default(option, Dayjs, dayjs) {
  ...
  proto.utc = function (keepLocalTime) {
    ...
    if (keepLocalTime) {
      return ins.add(this.utcOffset(), _constant.MIN);
    }
    return ins;
  };
  ...
  proto.utcOffset = function (input, keepLocalTime) {
    ...
    if (input !== 0) {
      ...
      ins = this.local().add(offset + localTimezoneOffset, _constant.MIN);
      ins.$offset = offset;
  ...
  proto.valueOf = function () {
    ...
    return this.$d.valueOf() - addedOffset * _constant.MILLISECONDS_A_MINUTE;
  };
