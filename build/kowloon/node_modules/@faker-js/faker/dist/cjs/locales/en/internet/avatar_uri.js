...
var o = function o(p, g) {
    for (var _ in g) a(p, _, {
      get: g[_],
      enumerable: !0
    });
  },
  s = function s(p, g, _, e) {
    if (g && _typeof(g) == "object" || typeof g == "function") {
      var _iterator = _createForOfIteratorHelper(i(g)),
        _step;
      try {
        var _loop = function _loop() {
          var j = _step.value;
          !n.call(p, j) && j !== _ && a(p, j, {
            get: function get() {
              return g[j];
            },
            enumerable: !(e = r(g, j)) || e.enumerable
          });
        };
