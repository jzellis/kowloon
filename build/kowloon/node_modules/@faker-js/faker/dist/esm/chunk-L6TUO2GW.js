...
var _chunk6XDWEJQU = require("./chunk-6XDWEJQU.mjs");
...
var na = {
  ...
  d = na;
var u = ["rojo", "verde", "azul", "amarillo", "morado", "Menta verde", "teal", "blanco", "negro", "Naranja", "Rosa", "gris", "marr\xF3n", "violeta", "turquesa", "tan", "cielo azul", "salm\xF3n", "ciruela", "orqu\xEDdea", "aceituna", "magenta", "Lima", "marfil", "\xEDndigo", "oro", "fucsia", "cian", "lavanda", "plata"];
var ta = {
    human: u
  },
  m = ta;
var p = ["Libros", "Pel\xEDculas", "M\xFAsica", "Juegos", "Electr\xF3nica", "Ordenadores", "Hogar", "Jard\xEDn", "Herramientas", "Ultramarinos", "Salud", "Belleza", "Juguetes", "Kids", "Baby", "Ropa", "Zapatos", "Joyer\xEDa", "Deportes", "Aire libre", "Automoci\xF3n", "Industrial"];
var g = {
  adjective: ["Peque\xF1o", "Ergon\xF3mico", "R\xFAstico", "Inteligente", "Gorgeous", "Incre\xEDble", "Fant\xE1stico", "Pr\xE1ctica", "Elegante", "Gen\xE9rica", "Artesanal", "Hecho a mano", "Licencia", "Refinado", "Sin marca", "Sabrosa"],
  material: ["Acero", "Madera", "Hormig\xF3n", "Pl\xE1stico", "Cotton", "Granito", "Caucho", "Metal", "Soft", "Fresco", "Frozen"],
  product: ["Presidente", "Auto", "Computadora", "Teclado", "Rat\xF3n", "Bike", "Pelota", "Guantes", "Pantalones", "Camisa", "Mesa", "Zapatos", "Sombrero", "Toallas", "Jab\xF3n", "Tuna", "Pollo", "Pescado", "Queso", "Tocino", "Pizza", "Ensalada", "Embutidos"]
};
var la = {
    department: p,
    product_name: g
...
var sa = {
  ...
  B = sa;
var P = ["com", "mx", "info", "com.mx", "org", "gob.mx"];
var h = ["gmail.com", "yahoo.com", "hotmail.com", "nearbpo.com", "corpfolder.com"];
var ca = {
    domain_suffix: P,
    free_email: h
  },
...
var y = ["M\xE9xico"];
var j = ["#####"];
var L = ["Esc. ###", "Puerta ###", "Edificio #"];
var T = ["Aguascalientes", "Baja California Norte", "Baja California Sur", "Estado de M\xE9xico", "Campeche", "Chiapas", "Chihuahua", "Coahuila", "Colima", "Durango", "Guanajuato", "Guerrero", "Hidalgo", "Jalisco", "Michoacan", "Morelos", "Nayarit", "Nuevo Le\xF3n", "Oaxaca", "Puebla", "Quer\xE9taro", "Quintana Roo", "San Luis Potos\xED", "Sinaloa", "Sonora", "Tabasco", "Tamaulipas", "Tlaxcala", "Veracruz", "Yucat\xE1n", "Zacatecas"];
var V = ["AS", "BC", "BS", "CC", "CS", "CH", "CL", "CM", "DF", "DG", "GT", "GR", "HG", "JC", "MC", "MN", "MS", "NT", "NL", "OC", "PL", "QT", "QR", "SP", "SL", "SR", "TC", "TS", "TL", "VZ", "YN", "ZS"];
var F = {
  normal: "{{location.street}}{{location.buildingNumber}}",
  full: "{{location.street}}{{location.buildingNumber}} {{location.secondaryAddress}}"
};
var J = ["20 de Noviembre", "Cinco de Mayo", "Cuahutemoc", "Manzanares", "Donceles", "Francisco I. Madero", "Ju\xE1rez", "Rep\xFAplica de Cuba", "Rep\xFAplica de Chile", "Rep\xFAplica de Argentina", "Rep\xFAplica de Uruguay", "Isabel la Cat\xF3lica", "Izazaga", "Eje Central", "Eje 6", "Eje 5", "La viga", "Aniceto Ortega", "Miguel \xC1ngel de Quevedo", "Amores", "Coyoac\xE1n", "Coru\xF1a", "Batalla de Naco", "La otra banda", "Piedra del Comal", "Balc\xF3n de los edecanes", "Barrio la Lonja", "Jicolapa", "Zacatl\xE1n", "Zapata", "Polotitlan", "Calimaya", "Flor Marina", "Flor Solvestre", "San Miguel", "Naranjo", "Cedro", "Jalisco", "Avena"];
var _ = ["{{location.street_suffix}} {{person.first_name}}", "{{location.street_suffix}} {{person.first_name}} {{person.last_name}}", "{{location.street_suffix}} {{location.street_name}}"];
var N = ["Aldea", "Apartamento", "Arrabal", "Arroyo", "Avenida", "Bajada", "Barranco", "Barrio", "Bloque", "Calle", "Calleja", "Camino", "Carretera", "Caserio", "Colegio", "Colonia", "Conjunto", "Cuesta", "Chalet", "Edificio", "Entrada", "Escalinata", "Explanada", "Extramuros", "Extrarradio", "Ferrocarril", "Glorieta", "Gran Subida", "Grupo", "Huerta", "Jardines", "Lado", "Lugar", "Manzana", "Mas\xEDa", "Mercado", "Monte", "Muelle", "Municipio", "Parcela", "Parque", "Partida", "Pasaje", "Paseo", "Plaza", "Poblado", "Pol\xEDgono", "Prolongaci\xF3n", "Puente", "Puerta", "Quinta", "Ramal", "Rambla", "Rampa", "Riera", "Rinc\xF3n", "Ronda", "Rua", "Salida", "Sector", "Secci\xF3n", "Senda", "Solar", "Subida", "Terrenos", "Torrente", "Traves\xEDa", "Urbanizaci\xF3n", "V\xEDa", "V\xEDa P\xFAblica"];
var da = {
    building_number: x,
    city_name: E,
    city_pattern: R,
...
var k = (0, _chunkTN4M2PHH.a)(r, i);
var X = ["Jr.", "Sr.", "I", "II", "III", "IV", "V", "MD", "DDS", "PhD", "DVM", "Ing.", "Lic.", "Dr.", "Mtro."];
var Y = {
  descriptor: ["Jefe", "Senior", "Directo", "Corporativo", "Din\xE1nmico", "Futuro", "Producto", "Nacional", "Regional", "Distrito", "Central", "Global", "Cliente", "Inversor", "International", "Heredado", "Adelante", "Interno", "Humano", "Gerente", "SubGerente", "Director"],
  level: ["Soluciones", "Programa", "Marca", "Seguridad", "Investigaci\xF3n", "Marketing", "Normas", "Implementaci\xF3n", "Integraci\xF3n", "Funcionalidad", "Respuesta", "Paradigma", "T\xE1cticas", "Identidad", "Mercados", "Grupo", "Divisi\xF3n", "Aplicaciones", "Optimizaci\xF3n", "Operaciones", "Infraestructura", "Intranet", "Comunicaciones", "Web", "Calidad", "Seguro", "Mobilidad", "Cuentas", "Datos", "Creativo", "Configuraci\xF3n", "Contabilidad", "Interacciones", "Factores", "Usabilidad", "M\xE9tricas"],
...
var Ca = {
  ...
  ia = Ca;
exports.a = ia;
var Dr = new _chunk2JBE4HP.h({
  locale: [ia, _chunk6XDWEJQU.a, _chunkTN4M2PHH.b, _chunk2JBE4HP.i]
});
exports.b = Dr;