// /routes/groups/members/collection.js
import route from "#routes/utils/route.js";
import { Group, Circle } from "#schema";

/**
 * GET /groups/:id/members
 * Members-only roster (or admin). Returns stubs + role badges.
 * Query:
 *   - page (default 1)
...
export default route(async ({ req, params, query, set, setStatus }) => {
  ...
  // 4) Simple page-based pagination (stable order as stored)
  ...
  const items = allMembers.slice(start, end);
