...
var o = ["{{company.prefix}} {{person.last_name}}", "{{person.last_name}} {{company.suffix}}", "{{company.prefix}} {{person.last_name}} {{company.suffix}}"];
var m = ["PT", "CV", "UD", "PD", "Perum", "Fa", "Yayasan", "KKB"];
var u = ["(Persero) Tbk", "Tbk"];
var U = {
    name_pattern: o,
    prefix: m,
    suffix: u
...
var v = {
  ...
  g = v;
var p = ["com", "net", "org", "asia", "tv", "biz", "info", "in", "name", "co", "id", "ac.id", "sch.id", "go.id", "mil.id", "co.id", "or.id", "web.id", "my.id", "net.id", "biz.id", "desa.id", "ponpes.id"];
var f = ["gmail.com", "yahoo.com", "gmail.co.id", "yahoo.co.id"];
var Y = {
    domain_suffix: p,
    free_email: f
  },
...
var A = ["{{location.street_prefix}} {{person.first_name}}", "{{location.street_prefix}} {{person.last_name}}"];
var B = ["Ds.", "Dk.", "Gg.", "Jln.", "Jr.", "Kpg.", "Ki.", "Psr."];
var z = {
    building_number: y,
    city_name: k,
    city_pattern: S,
...
var G = null;
var W = ["S.Ked", "S.Gz", "S.Pt", "S.IP", "S.E.I", "S.E.", "S.Kom", "S.H.", "S.T.", "S.Pd", "S.Psi", "S.I.Kom", "S.Sos", "S.Farm", "M.M.", "M.Kom.", "M.TI.", "M.Pd", "M.Farm", "M.Ak"];
var V = {
    female_first_name: a,
    female_last_name: c,
    female_last_name_pattern: j,
    female_prefix: N,
    female_title: T,
    first_name: R,
    male_first_name: i,
    male_last_name: H,
    male_last_name_pattern: J,
    male_prefix: L,
    male_title: C,
    name: x,
    prefix: G,
  ...
  I = V;
var _ = ["02# #### ###", "02## #### ###", "03## #### ###", "04## #### ###", "05## #### ###", "06## #### ###", "07## #### ###", "09## #### ###", "02# #### ####", "02## #### ####", "03## #### ####", "04## #### ####", "05## #### ####", "06## #### ####", "07## #### ####", "09## #### ####", "08## ### ###", "08## #### ###", "08## #### ####", "(+62) 8## ### ###", "(+62) 2# #### ###", "(+62) 2## #### ###", "(+62) 3## #### ###", "(+62) 4## #### ###", "(+62) 5## #### ###", "(+62) 6## #### ###", "(+62) 7## #### ###", "(+62) 8## #### ###", "(+62) 9## #### ###", "(+62) 2# #### ####", "(+62) 2## #### ####", "(+62) 3## #### ####", "(+62) 4## #### ####", "(+62) 5## #### ####", "(+62) 6## #### ####", "(+62) 7## #### ####", "(+62) 8## #### ####", "(+62) 9## #### ####"];
var Z = {
    formats: _
  },
  E = Z;
var q = {
  ...
  F = q;
exports.a = F;
var ci = new _chunk2JBE4HP.h({
  locale: [F, _chunkTN4M2PHH.b, _chunk2JBE4HP.i]
});
exports.b = ci;