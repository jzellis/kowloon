...
var ZRANDMEMBER_COUNT_1 = require("./ZRANDMEMBER_COUNT");
...
function transformArguments() {
  return [].concat(_toConsumableArray((0, ZRANDMEMBER_COUNT_1.transformArguments).apply(void 0, arguments)), ['WITHSCORES']);
}
