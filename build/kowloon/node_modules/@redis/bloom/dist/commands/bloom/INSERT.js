...
function transformArguments(key, items, options) {
  ...
  if (options !== null && options !== void 0 && options.CAPACITY) {
    args.push('CAPACITY', options.CAPACITY.toString());
  }
  if (options !== null && options !== void 0 && options.ERROR) {
    args.push('ERROR', options.ERROR.toString());
  }
  if (options !== null && options !== void 0 && options.EXPANSION) {
    args.push('EXPANSION', options.EXPANSION.toString());
  }
  if (options !== null && options !== void 0 && options.NOCREATE) {
    args.push('NOCREATE');
  }
  if (options !== null && options !== void 0 && options.NONSCALING) {
