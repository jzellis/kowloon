...
var Y = {
  ...
  v = Y;
var p = ["{{person.last_name}} {{company.suffix}}", "{{person.last_name}} \xE9s {{person.last_name}} {{company.suffix}}", "{{person.last_name}} \xE9s Tsa. {{company.suffix}}", "{{person.last_name}} 2000 {{company.suffix}}"];
var f = ["Kft.", "Bt.", "Zrt.", "Nyrt.", "Kv.", "Kkt."];
var q = {
    name_pattern: p,
    suffix: f
  },
...
var h = {
  ...
  abbr: ["jan.", "febr.", "m\xE1rc.", "\xE1pr.", "m\xE1j.", "j\xFAn.", "j\xFAl.", "aug.", "szept.", "okt.", "nov.", "dec."]
};
var c = {
  wide: ["h\xE9tf\u0151", "kedd", "szerda", "cs\xFCt\xF6rt\xF6k", "p\xE9ntek", "szombat", "vas\xE1rnap"],
  abbr: ["H\xE9", "Ke", "Sze", "Cs\xFCt", "P\xE9", "Szo", "Va"]
};
var Q = {
    month: h,
    weekday: c
  ...
  j = Q;
var x = ["Fizet\xE9si", "Megtakarit\xE1s", "Money Market", "Befektet\xE9s", "Lak\xE1shitel", "Hitelk\xE1rtya", "G\xE9pj\xE1rm\u0171 k\xF6lcs\xF6n", "Szem\xE9lyi k\xF6lcs\xF6n"];
var S = ["p\xE9nzbefizet\xE9s", "p\xE9nzfelv\xE9tel", "fizet\xE9s", "sz\xE1ml\xE1z\xE1s"];
var X = {
    account_type: x,
    transaction_type: S
  },
  B = X;
var A = ["com", "hu", "eu", "net", "org"];
var K = ["gmail.com", "hotmail.hu", "hotamil.com", "freemail.hu", "citromail.hu", "outlook.com", "outlook.hu"];
var $ = {
    domain_suffix: A,
    free_email: K
  },
  M = $;
var P = ["B\xE1cs-Kiskun", "Baranya", "B\xE9k\xE9s", "Borsod-Aba\xFAj-Zempl\xE9n", "Budapest", "Csongr\xE1d-Csan\xE1d", "Fej\xE9r", "Gy\u0151r-Moson-Sopron", "Hajd\xFA-Bihar", "Heves", "J\xE1sz-Nagykun-Szolnok", "Kom\xE1rom-Esztergom", "N\xF3gr\xE1d", "Pest", "Somogy", "Szabolcs-Szatm\xE1r-Bereg", "Tolna", "Vas", "Veszpr\xE9m", "Zala"];
var ee = {
    state: P
  },
  C = ee;
...
var re = {
  ...
  Z = re;
exports.a = Z;
var Ya = new _chunk2JBE4HP.h({
  locale: [Z, _chunkTN4M2PHH.b, _chunk2JBE4HP.i]
});
exports.b = Ya;