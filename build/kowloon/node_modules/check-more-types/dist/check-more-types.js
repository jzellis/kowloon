...
(function webpackUniversalModuleDefinition(root, factory) {
  if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && (typeof module === "undefined" ? "undefined" : _typeof(module)) === 'object') module.exports = factory();else if (typeof define === 'function' && define.amd) define([], factory);else if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object') exports["check"] = factory();else root["check"] = factory();
})(void 0, function () {
  return (/******/function (modules) {
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      */
      ...
      function isObject(x) {
        return _typeof(x) === 'object' && !isArray(x) && !isNull(x) && !isDate(x);
      }
      ...
      */
      function validDate(value) {
        return isDate(value) && isNumber(Number(value));
      }
      ...
      */
      function primitive(value) {
        ...
        return type === 'number' || type === 'boolean' || type === 'string' || type === 'symbol';
      }
      ...
      */
      function has(o, property) {
        ...
        return Boolean(o && property && typeof property === 'string' && typeof o[property] !== 'undefined');
      }
      ...
      */
      function empty(a) {
        var hasLength = typeof a === 'string' || Array.isArray(a);
        if (hasLength) {
          return !a.length;
        }
      ...
      function curry2(fn, strict2) {
        return function curried(a) {
          if (strict2 && arguments.length > 2) {
            throw new Error('Curry2 function ' + fn.name + ' called with too many arguments ' + arguments.length);
          }
          if (arguments.length === 2) {
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      */
      ...
      function startsWith(prefix, x) {
        return low.string(prefix) && low.string(x) && x.indexOf(prefix) === 0;
      }
      ...
      */
      function type(expectedType, x) {
        return _typeof(x) === expectedType; // eslint-disable-line valid-typeof
      }
      ...
      */
      function index(list, k) {
        return low.defined(list) && low.has(list, 'length') && k >= 0 && k < list.length;
      }
      ...
      */
      function unit(value) {
        return low.number(value) && value >= 0.0 && value <= 1.0;
      }
      ...
      */
      function hexRgb(value) {
        return low.string(value) && rgb.test(value);
      }
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      */
      function semver(s) {
        return low.unemptyString(s) && /^\d+\.\d+\.\d+$/.test(s);
      }
      ...
      */
      function git(url) {
        return low.unemptyString(url) && /^git@/.test(url);
      }
      ...
      */
      function commitId(id) {
        return low.string(id) && id.length === 40 && shaReg.test(id);
      }
      ...
      */
      function shortCommitId(id) {
        return low.string(id) && id.length === 7 && shortShaReg.test(id);
      }
      module.exports = {
        semver: semver,
        git: git,
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      function webUrl(x) {
        return low.string(x) && (startsWithHttp(x) || startsWithHttps(x));
      }
