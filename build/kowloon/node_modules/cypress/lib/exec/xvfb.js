...
var debug = Debug('cypress:cli');
var debugXvfb = Debug('cypress:xvfb');
...
module.exports = {
  ...
  isNeeded: function isNeeded() {
    ...
    if (process.env.DISPLAY) {
      ...
      var message = stripIndent(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n        DISPLAY environment variable is set to ", " on Linux\n        Assuming this DISPLAY points at working X11 server,\n        Cypress will not spawn own Xvfb\n\n        NOTE: if the X11 server is NOT working, Cypress will exit without explanation,\n          see ", "\n        Solution: Unset the DISPLAY variable and try again:\n          DISPLAY= npx cypress run ...\n      "])), process.env.DISPLAY, issueUrl);
      debug(message);
      return false;
    }
